...
- **Configurable pipeline** — declare detectors in a `pipeline.toml` file and pass it at startup with `--config`.
...
- [Quickstart](getting-started/quickstart.md) — write a `pipeline.toml` and make your first request.
